...
export const DocumentAnalyzerView: React.FC<DocumentAnalyzerViewProps> = ({ clientId }) => {
  ...
  return (
    <div className="flex-1 flex flex-col space-y-4 pb-28 max-w-6xl mx-auto w-full">
      {/* View Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-[#3d363f]">
      ...
      {!selectedFile ? (
        ...
        <div
          ...
          className="flex-1 min-h-[350px] border-2 border-dashed border-[#3d363f] hover:border-[#9013fe]/60 rounded-2xl bg-[#221f23]/50 hover:bg-[#221f23] flex flex-col items-center justify-center p-8 transition cursor-pointer text-center group"
        >
          <input
            ref={fileInputRef}
            type="file"
            ...
            className="hidden"
          />
          <div className="w-16 h-16 rounded-2xl bg-[#1d1a1e] border border-[#3d363f] group-hover:border-[#9013fe]/40 flex items-center justify-center mb-4 text-slate-400 group-hover:text-[#d8b4fe] transition shadow-lg">
          ...
          <span className="text-[11px] font-mono px-2.5 py-1 rounded bg-[#1d1a1e] border border-[#3d363f] text-slate-400">
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-4 min-h-[500px]">
          ...
          <div className="rounded-xl bg-[#221f23] border border-[#3d363f] flex flex-col overflow-hidden">
            <div className="p-3 border-b border-[#3d363f] bg-[#1d1a1e] flex items-center justify-between text-xs">
            ...
            <div className="flex-1 p-2 bg-[#1d1a1e]/50 min-h-[350px]">
              {filePreviewUrl ? (
                <iframe
                  src={filePreviewUrl}
                  title="PDF Preview"
                  className="w-full h-full rounded border border-[#3d363f]"
                />
              ) : (
          ...
          <div className="rounded-xl bg-[#221f23] border border-[#3d363f] flex flex-col overflow-hidden min-h-[400px]">
            <div className="p-3 border-b border-[#3d363f] bg-[#1d1a1e] text-xs font-semibold text-slate-300 flex items-center space-x-2">
              <Sparkles className="w-3.5 h-3.5 text-[#c084fc]" />
            ...
            <div className="flex-1 p-4 overflow-y-auto space-y-4 max-h-[450px]">
                ...
                <div
                  ...
                  className={`p-3.5 rounded-xl text-xs leading-relaxed ${
                    turn.role === 'user'
                      ...
                      : 'bg-[#1d1a1e] border border-[#3d363f] text-slate-200 mr-2'
                  }`}
                >
              ...
              {isStreaming && (
                <div className="p-3.5 rounded-xl bg-[#1d1a1e] border border-[#3d363f] text-xs text-slate-200 mr-2 space-y-2">
            ...
            <div className="p-3 border-t border-[#3d363f] bg-[#1d1a1e] flex items-center space-x-2">
              <input
                type="text"
                value={query}
                ...
                className="flex-1 bg-[#221f23] border border-[#3d363f] rounded-lg px-3 py-2 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:border-[#9013fe]"
              />
              <button
