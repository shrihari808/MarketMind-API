...
async def lifespan(app: FastAPI):
    ...
    scheduler.add_job(aggregate_and_process_data, 'interval', minutes=60, args=["IN", "India"])
    scheduler.add_job(aggregate_and_process_data, 'interval', minutes=120, args=["US", "USA"])
    scheduler.add_job(generate_trending_stocks_data, 'interval', minutes=90, args=["IN"])
    scheduler.add_job(generate_trending_stocks_data, 'interval', minutes=180, args=["US"])
